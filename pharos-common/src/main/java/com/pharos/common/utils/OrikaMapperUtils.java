...
public class OrikaMapperUtils {
     ...
     * 极致性能的复制出新类型对象.
     * <p>
     * 预先通过{@link com.webuy.jlwork.common.utils.OrikaMapperUtils#getType(Class)} 静态获取并缓存Type类型，在此处传入
     */
     ...
     * 极致性能的复制出新类型对象到数组.
     * <p>
     * 需要预先通过{@link com.webuy.jlwork.common.utils.OrikaMapperUtils#getType(Class)} 静态获取并缓存转换所需Type类型，在此处传入
     *
     * @param destination     要复制到的目标数组
     * @param source          待复制的源数据数组
